...
jest.mock('../src/mockFunctions'); // foi feito um mock do módulo

describe('verifica as funções e os mocks', () => {
  test('testa função add', () => {
    mockFunctions.add.mockImplementation((a, b) => a + b); // foi feito um mock da implementação da função add
  ...
  test('testa função subtract', () => {
    mockFunctions.subtract.mockImplementation((a, b) => a - b); // foi feito um mock da implementação da função subtract
  ...
  test('testa função multiply', () => {
    mockFunctions.multiply.mockImplementation((a, b) => a * b); // foi feito um mock da implementação da função multiply
  ...
  test('testa função divide', () => {
    mockFunctions.divide.mockImplementation((a, b) => a / b); // foi feito um mock da implementação da função divide
  ...
  test('testa função power', () => {
    mockFunctions.power.mockImplementation((a, b) => a ** b); // foi feito um mock da implementação da função power
  ...
  test('testa função factorial', () => {
    mockFunctions.factorial.mockImplementation((a) => {
      ...
      return atual;
    }); // foi feito um mock da implementação da função factorial
